(function () {
  ...
  // vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv  
  class NewChartsV123A extends HTMLElement {
    constructor () {
      super()
    ...
    onCustomWidgetAfterUpdate() {
        ...
        new Promise(resolve => {
            ...
            script.src = 'https://armando-j-a-santos.github.io/ECHARTS/originalcode/originalsJSfiles/index.js'
            script.onload = () => {
              resolve(script)
              console.log('loaded github index.js')
            }
        ...
        new Promise(resolve => {
            let script = document.createElement('script')
            script.src = 'https://armando-j-a-santos.github.io/ECHARTS/originalcode/originalsJSfiles/xy.js'
            script.onload = () => {
              resolve(script)
              console.log('loaded github xy.js')
            }
            this._shadowRoot.appendChild(script)
        })
        ...
        new Promise(resolve => {
            let script = document.createElement('script')
            script.src = 'https://armando-j-a-santos.github.io/ECHARTS/originalcode/originalsJSfiles/Animated.js'
            script.onload = () => {
              resolve(script)
              console.log('loaded github Animated.js')
            }
            this._shadowRoot.appendChild(script)
        })
  ...
  // vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
  customElements.define('com-sap-sample-asantos-new-chartsv123a', NewChartsV123A)
