                    ...
                    return (0, a.ZT)(t, e), Object.defineProperty(t.prototype, "_afterNew", {
                        ...
                        value: function() {
                            ...
                            if (o.isNumber(e) && o.isNumber(t)) {
                                ...
                                for (this.setPrivateRaw("gridInterval", d); h < n + g;) {
                                    ...
                                    var x = h + c.getDuration(d.timeUnit, 1.1 * d.count);
                                    x = c.round(new Date(x), d.timeUnit, d.count, this._root.locale.firstDayOfWeek, this._root.utc, void 0, this._root.timezone).getTime(), _.setRaw("endValue", x);
                                    var w = new Date(h);
                        ...
                        value: function(e) {
                            var t = this.getPrivate("baseInterval"),
                                ...
                                a = i + c.getDuration(t.timeUnit, 1.1 * t.count);
                            return i + ((a = c.round(new Date(a), t.timeUnit, t.count, this._root.locale.firstDayOfWeek, this._root.utc, void 0, this._root.timezone).getTime()) - i) * this.get("startLocation", 0)
                        }
                        ...
                        value: function(e) {
                            var t = this.getPrivate("baseInterval"),
                                i = c.round(new Date(e), t.timeUnit, t.count, this._root.locale.firstDayOfWeek, this._root.utc, void 0, this._root.timezone).getTime(),
                                a = i + c.getDuration(t.timeUnit, 1.1 * t.count);
                            return i + ((a = c.round(new Date(a), t.timeUnit, t.count, this._root.locale.firstDayOfWeek, this._root.utc, void 0, this._root.timezone).getTime()) - i) * this.get("endLocation", 1)
                        }
                        ...
                        value: function(e, t) {
                            ...
                            if (!o.isNaN(i)) {
                                ...
                                return t > 0 && (r = i + 1.1 * c.getDuration(a.timeUnit, a.count), r = c.round(new Date(r), a.timeUnit, a.count, this._root.locale.firstDayOfWeek, this._root.utc, new Date(this.getPrivate("min", 0)), this._root.timezone).getTime()), this.valueToPosition(i + (r - i) * t)
                            }
                            return NaN
                        }
                        ...
                        value: function() {
                            ...
                            if (u.isNumber(t) && u.isNumber(i)) {
                                ...
                                for (var O = l.round(new Date(this.getPrivate("min", 0)), v.timeUnit, v.count, this._root.locale.firstDayOfWeek, this._root.utc, P, this._root.timezone), T = l.add(O, v.timeUnit, -1, this._root.utc, this._root.timezone).getTime(), D = this.getPrivate("selectionMax"), j = -1 / 0, A = (this.get("end", 1) - this.get("start", 0)) / b; T <= D;) {
                                    ...
                                    var X = T;
                                    if (T += l.getDuration(v.timeUnit, 1.1 * v.count), (T = l.round(new Date(T), v.timeUnit, v.count, this._root.locale.firstDayOfWeek, this._root.utc, void 0, this._root.timezone).getTime()) == X) break
                                }
                                if (w.length > 0) {
                                    var S = 0,
                                        F = T - 10 * _,
                ...
                c = function(e) {
                    ...
                    return (0, a.ZT)(t, e), Object.defineProperty(t.prototype, "markDirtyExtremes", {
                        ...
                        value: function() {
                            ...
                            }(this._sizeDirty || this._dirtyExtremes || this._valuesDirty || this.isPrivateDirty("width") || this.isPrivateDirty("height") || this.isDirty("min") || this.isDirty("max") || this.isDirty("extraMin") || this.isDirty("extraMax") || this.isDirty("logarithmic") || this.isDirty("treatZeroAs") || this.isDirty("baseValue") || this.isDirty("strictMinMax") || this.isDirty("strictMinMaxSelection") || this.isDirty("maxPrecision") || this.isDirty("numberFormat")) && (this._getMinMax(), this.ghostLabel.set("text", ""), this._dirtyExtremes = !1), this._dirtySelectionExtremes && !this._isPanning && this.get("autoZoom", !0) && (this._getSelectionMinMax(), this._dirtySelectionExtremes = !1), this._groupData(), (this._sizeDirty || this._valuesDirty || this.isDirty("start") || this.isDirty("end") || this.isPrivateDirty("min") || this.isPrivateDirty("selectionMax") || this.isPrivateDirty("selectionMin") || this.isPrivateDirty("max") || this.isPrivateDirty("step") || this.isPrivateDirty("width") || this.isPrivateDirty("height") || this.isDirty("logarithmic")) && (this._handleRangeChange(), this._prepareAxisItems(), this._updateAxisRanges()), 
